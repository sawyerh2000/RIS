...
public class Orders extends JFrame {
	...
	public Orders() {
		...
		ordersBtn.setFont(new Font("Tahoma", Font.PLAIN, 16));
		...
		lblNewLabel_1.setBounds(750, 63, 94, 26);
		...
		JLabel lblNewLabel_4 = new JLabel("5 / 8");
		...
		JLabel lblNewLabel_5 = new JLabel("Appointments");
		...
		lblNewLabel_3.setBounds(670, 750, 62, 31);
		...
		JLabel lblNewLabel_3_1 = new JLabel("Order ID");
		lblNewLabel_3_1.setFont(new Font("Tahoma", Font.BOLD, 14));
		lblNewLabel_3_1.setBounds(30, 158, 80, 17);
		contentPane.add(lblNewLabel_3_1);
		
		JLabel lblNewLabel_3_1_1 = new JLabel("Patient");
		lblNewLabel_3_1_1.setFont(new Font("Tahoma", Font.BOLD, 14));
		lblNewLabel_3_1_1.setBounds(300, 158, 101, 17);
		contentPane.add(lblNewLabel_3_1_1);
		
		JLabel lblNewLabel_3_1_1_1 = new JLabel("Referral MD");
		lblNewLabel_3_1_1_1.setFont(new Font("Tahoma", Font.BOLD, 14));
		lblNewLabel_3_1_1_1.setBounds(500, 158, 87, 17);
		contentPane.add(lblNewLabel_3_1_1_1);
		
		JLabel lblNewLabel_3_1_1_1_1 = new JLabel("Modaility");
		lblNewLabel_3_1_1_1_1.setFont(new Font("Tahoma", Font.BOLD, 14));
		lblNewLabel_3_1_1_1_1.setBounds(700, 158, 101, 17);
		...
		JLabel lblNewLabel_3_1_1_1_1_1 = new JLabel("Notes");
		lblNewLabel_3_1_1_1_1_1.setFont(new Font("Tahoma", Font.BOLD, 14));
		lblNewLabel_3_1_1_1_1_1.setBounds(900, 158, 101, 17);
		contentPane.add(lblNewLabel_3_1_1_1_1_1);
		
		JLabel lblNewLabel_3_1_1_1_1_1_1 = new JLabel("Status");
