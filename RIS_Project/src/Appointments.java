...
public class Appointments extends JFrame {
	...
	public Appointments() {
		...
		appointmentsBtn.setFont(new Font("Tahoma", Font.PLAIN, 16));
		...
		JLabel lblNewLabel_1 = new JLabel("Appointments");
		...
		JLabel lblNewLabel_4 = new JLabel("6 / 8");
		...
		JLabel lblNewLabel_5 = new JLabel("File Uploads");
		...
		lblNewLabel_3.setBounds(681, 750, 62, 31);
		...
		JLabel lblNewLabel_3_1 = new JLabel("Appointment ID");
		...
		JLabel lblNewLabel_3_1_1_1_1_1 = new JLabel("Technician");
		...
		JLabel lblNewLabel_3_1_1_1_1_1_1 = new JLabel("Radiologist");
