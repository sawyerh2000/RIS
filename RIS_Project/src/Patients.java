...
public class Patients extends JFrame {
	...
	public Patients() {
		...
		JLabel lblNewLabel_4 = new JLabel("4 / 8");
		...
		JLabel lblNewLabel_5 = new JLabel("Orders");
		lblNewLabel_5.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblNewLabel_5.setBounds(900, 750, 94, 31);
		contentPane.add(lblNewLabel_5);
		
		JLabel lblNewLabel_3 = new JLabel("Patient Alerts");
		lblNewLabel_3.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblNewLabel_3.setBounds(636, 750, 94, 31);
		...
		JLabel lblNewLabel_3_1 = new JLabel("Patient ID");
		...
		JLabel lblNewLabel_3_1_1_1 = new JLabel("Last Name");
		lblNewLabel_3_1_1_1.setFont(new Font("Tahoma", Font.BOLD, 14));
		lblNewLabel_3_1_1_1.setBounds(500, 158, 101, 17);
		contentPane.add(lblNewLabel_3_1_1_1);
		
		JLabel lblNewLabel_3_1_1_1_1 = new JLabel("First Name");
		lblNewLabel_3_1_1_1_1.setFont(new Font("Tahoma", Font.BOLD, 14));
		lblNewLabel_3_1_1_1_1.setBounds(750, 158, 101, 17);
